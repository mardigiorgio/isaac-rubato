...
TASK="${TASK:-Isaac-Reach-Franka-Rubato}"   # the gym id registered in this folder's env.py
GROUP="${GROUP:-franka_reach}"              # W&B group: pairs THIS example's fixed+adaptive runs
# ================================================================
